...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const CameraProcessingScreen(),
    );
  }
}
...
class ImageService {
  ...
  Future<XFile> convertImageToXFile(
    ...
    final args = _ImageToXFileConvertorInput(
      path,
      pickedImage,
      resultPort.sendPort,
    );
  ...
  ///Rotating
  image.Image rotateImage(image.Image sourceImage, {required int angle}) {
  ...
  Future<void> _convertImageToXFileIsolate(
    ...
    try {
      ...
      final tempFile = await File(
        imageToXFileConvertorInput.path,
