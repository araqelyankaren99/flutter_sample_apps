...
import 'package:flutter_sample_apps/screens/login_signup/phone_number/phone_number_bloc/phone_number_bloc.dart';
...
import 'package:flutter_sample_apps/screens/login_signup/shared/center_text_widget.dart';
import 'package:flutter_sample_apps/screens/login_signup/shared/create_text_widget.dart';
import 'package:flutter_sample_apps/screens/login_signup/shared/phone_number/phone_number_field.dart';
import 'package:flutter_sample_apps/screens/login_signup/shared/phone_number/security_text_widget.dart';
import 'package:flutter_sample_apps/screens/login_signup/shared/phone_number/verification_text_widget.dart';
import 'package:flutter_sample_apps/screens/login_signup/verification/phone_verify_screen.dart';
...
class PhoneNumberScreen extends StatefulWidget {
  const PhoneNumberScreen({required this.loginType});
...
class _PhoneNumberScreenState extends State<PhoneNumberScreen> {
  ...
  Widget _renderBody() {
    return BlocBuilder<PhoneNumberBloc, PhoneNumberState>(
      ...
      return Scaffold(
          ...
          body: SingleChildScrollView(child: _renderFieldOnScreen(state)),);
    },);
  }
  ...
  Widget _renderNextButton(PhoneNumberState state) {
    return NextButton(
      ...
      showLoading: state is PhoneNumberLoadingState,
  ...
  /// This method call when can't tap next button
  ...
  void _phoneNumberBlocListener(BuildContext context, PhoneNumberState state) {
