...
const cloudBurstColor = Color.fromRGBO(34, 43, 69, 1.0);
const cornflowerBlueColor = Color.fromRGBO(1, 118, 255, 1.0);
const geyserColor = Color.fromRGBO(213, 221, 224, 1.0);
