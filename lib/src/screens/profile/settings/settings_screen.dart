...
import 'package:flutter_sample_apps/src/screens/profile/about_app/about_app_page.dart';
...
import 'package:flutter_sample_apps/src/screens/profile/settings/settings_bloc/settings_bloc.dart';
    ...
    switch (expansionItem.expansionType) {
      ...
      case ExpansionType.logOut:
        AlertWidget.showConfirmAlertDialog(context,
            ...
            accept: 'Log out',
            onAcceptAction: () =>
                _profileInformationBloc.add(const UserLogOutEvent()));
        break;
    }
  }

  void _settingsBlocListener(context, state) {
